...
{
    [CustomEditor(typeof(Core.AdvancedCharacterController))]
    public class AdvancedCharacterControllerEditor : UnityEditor.Editor
    {
        private Core.AdvancedCharacterController _controller;
        ...
        {
            _controller = (Core.AdvancedCharacterController) target;
